...
CARROS_IMGS = [
    pygame.transform.scale(pygame.image.load("carro1.png"), (40, 40)),
    pygame.transform.scale(pygame.image.load("carro2.png"), (40, 40)),
    pygame.transform.scale(pygame.image.load("carro3.png"), (40, 40)),
]
